...
router.post("/weights", authMiddleware, authorizeRoles("Admin", "PT"), (req, res) =>
  exerciseController.createWeights(req, res)
);
...
router.delete("/:id", authMiddleware, authorizeRoles("Admin", "PT"), (req, res) =>
