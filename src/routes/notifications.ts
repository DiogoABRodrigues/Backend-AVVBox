...
router.get("/:targetId", authMiddleware, (req, res) =>
  notificationController.getByUser(req, res),
);

// Deletar notificação específica de um user
router.delete("/:notificationId/:userId", authMiddleware, (req, res) =>
  notificationController.deleteForUser(req, res),
);

// Marcar notificação como lida
router.post("/:notificationId/:userId/read", authMiddleware, (req, res) =>
